...
\name{Bruce D. Marron}
\address{Vito Alessio Robles 237, Dept 9, Agricola Chamalistac, Álvaro Obregón, CDMX, Mexico CP 01050}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0.4,-5.5) {\includegraphics[scale=0.05]{graphics/Marron_Bass.jpeg}};  
 \end{tikzpicture}
 ...
 %% Pic 3
 \begin{tikzpicture}[overlay]
  \node[anchor=south west] at (13,-4.8) {\includegraphics[scale=0.11]{graphics/Marron_Orchestra.jpeg}};  
 \end{tikzpicture}
 
 %% Pic 4
 \begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0.1,-7.5) {\includegraphics[scale=0.1]{graphics/Marron_LVTB.jpeg}};  
 \end{tikzpicture}
 
  %% Pic 5
 \begin{tikzpicture}[overlay]
  \node[anchor=south west] at (7,-9.0) {\includegraphics[scale=0.03]{graphics/MOZ_CartelFinal.jpg}};  
 \end{tikzpicture}
 
 %% Pic 6
 \begin{tikzpicture}[overlay]
  \node[anchor=south west] at (13,-7.5) {\includegraphics[scale=0.11]{graphics/Marron_StarfireMusic.jpeg}};  
 \end{tikzpicture}
