...
tr_d=cPickle.load(open("/home/bmarron/Desktop/PSU/PhD_EES/SoE/2016SoE009_CS545_MachineLearning/_PWFs_work_inprogress/Hwk2/DataFiles/Input_Data/Processed/tr_d/tr_d.pkl","rb"))


#%% The Neural Network (w/ momentum)
...
#        return sum(results)
    ...
    def evaluate(self, te_d): 
        test_results = [(np.argmax(self.feedforward(x)), np.argmax(y)) for (x, y) in te_d]
