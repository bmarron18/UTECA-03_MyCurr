...
#%%Generate 5 sets of k=30 random cluster centers
# shape of the centers ==> shape(k, n_features)

np.random.seed(57)
rcc1=np.random.randint(0, 16, (30, 64))

np.random.seed(157)
rcc2=np.random.randint(0, 16, (30, 64))

np.random.seed(257)
rcc3=np.random.randint(0, 16, (30, 64))

np.random.seed(357)
rcc4=np.random.randint(0, 16, (30, 64))

np.random.seed(457)
rcc5=np.random.randint(0, 16, (30, 64))
...
#%% First iteration of run (<fill-in> of 5) of k-means for k=30
