...
%--------- Chapter 1 -------------------------
\chapter{Discrete Entity Generators and Their Ouputs}
\section{Introduction}
The standard textbook rhetoric for introducing discrete probability usually includes dice, cards.

\section{Discrete Entity Generators}
Discrete entity generators ouput sets of observable entities with observable characteristics. Both the entities and the characteristics are uniquely identifiable through observation at a specified scale. The casual mechanisms operating in the generation of outputs are acknowledged but are generally left outside of the system under investigation.  
\section{Output Spaces}
\subsection*{Sequences}
\subsection*{Collections}
\section{Counts in the Output Spaces}
\subsection*{Sequences}
\subsection*{Collections}


\section{Introduction to Probability Models, Sheldon Ross}
\subsection*{Ross Examples}
