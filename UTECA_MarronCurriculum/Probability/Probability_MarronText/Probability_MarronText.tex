...
% 29Aug2025 --
% needed to 1) update biblatex pkg 2) block code maxcitenames=2, mincitenames=1, maxbibnames=10,



% May be able to just run LaTex -> PDF (Latexmk) in LaTexila (2x)
...
\addbibresource{/home/bruce/Desktop/BibLatex/My_Library_20201129.bib} % BibTeX bibliography file
...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(80,100){\includegraphics[scale=1.5]{graphics/drawing1a.png}}} % Image background; * means only on this page
\vspace*{4cm}     %from the top of page
\centering{
\normalfont\fontsize{35}{35}\sffamily\selectfont
\textbf{A Systems-Based Approach to Probability}\\  % Book title
\vspace*{1cm}    % between title and client/author lines
{\LARGE \textbf % {Produced for: UTECA\\ % client line
